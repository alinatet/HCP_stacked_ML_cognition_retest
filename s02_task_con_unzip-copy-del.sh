...
do
    ...
    mkdir $path/${folders[i]}/z_analysis
    mkdir $path/${folders[i]}/z_analysis/MSMAll_con
    ...
    do
        ...
        #copy
        cp $path/${folders[i]}/folders/$subject/MNINonLinear/Results/*/*_level2_MSMAll.feat/GrayordinatesStats/cope${numcon[i]}.feat/zstat1.dtseries.nii $path/${folders[i]}/z_analysis/MSMAll_con/$subject.${folders[i]}.cope${numcon[i]}.zstat1.dtseries.nii
        #del
